    ...
    {   
        ...
        $userPasswordHasher->hashPassword(
            ...
            $this->emailVerifier->sendEmailConfirmation('app_verify_email', $user,
                (new TemplatedEmail())
                    ->from(new Address('ricardokwapiszparejo@gmail.com', '"RICARDO MAIL"'))
                    ->to($user->getEmail())
            ...
            return new JsonResponse($data, Response::HTTP_OK, [], true); //modificar , voy a devolver un json o un string
        //}
